...
class OPMode:
    ...
    def _create_join_operation(
        ...
        Args:
            ...
            operation_type: 操作类型 ("left_join" 或 "full_join")
        ...
        if callable(other):
            ...
            return (operation_type, condition_func, data_func)
        else:
    ...
    def __mul__(
        ...
        """
        return self._create_join_operation(other, "left_join")
    ...
    def __pow__(
        ...
        Example:
            ...
            DATA ** data_func  # data_func 返回数据或从stream_join参数获取条件
        """
        return self._create_join_operation(other, "full_join")
